    ...
    return (
        <ProtectedRoute>
            <div className={"flex justify-center flex-col"}>                
                <SubHeader name="Follow" icon={<FaUsers size={20}/>} sticky={true}/>
                    ...
                    <div className={"flex flex-col justify-content items-center gap-2"}>
                        {
                            friendcard.map((_, index) => (
                                <FriendCard className={"lg:w-full md:w-[70%]"} key={index} name={"Jean Doe"}
                                            mutualFriends={20} avatar={"/assets/profile.jpg"}/>
                            ))
                        }
                    </div>
